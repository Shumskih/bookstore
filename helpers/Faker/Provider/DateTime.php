...
class DateTime extends Base
{
    ...
    {
        return ((null === $timezone) ? ((null === static::$defaultTimezone) ? date_default_timezone_get()
     ...
     *
     * @param \DateTime|int|string $max      maximum timestamp used as random end limit, default to "now"
     * @param string               $timezone time zone in which the date time should be set, default to
     *                                       DateTime::$defaultTimezone, if set, otherwise the result of
     *                                       `date_default_timezone_get`
     *
