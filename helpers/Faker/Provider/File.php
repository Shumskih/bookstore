...
class File extends Base
{
    ...
    protected static $mimeTypes
      = [
        ...
        'models/vnd.mts'                                                            => 'mts',
        'models/vnd.vtu'                                                            => 'vtu',
        'models/vrml'                                                               => ['wrl', 'vrml'],
        'models/x3d+binary'                                                         => 'x3db',
    ...
    public static function file($sourceDirectory = '/tmp', $targetDirectory = '/tmp', $fullPath = true)
    {
        ...
        $files = array_filter(array_values(array_diff(scandir($sourceDirectory), ['.', '..'])),
          function ($file) use ($sourceDirectory) {
              return is_file($sourceDirectory . DIRECTORY_SEPARATOR . $file)
                     && is_readable($sourceDirectory . DIRECTORY_SEPARATOR . $file);
          });
