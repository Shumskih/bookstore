        ...
        <div class="row">
              ...
              <div class="customar__field">
                <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
                  ...
                  <div class="input_box">
                    ...
                    <select class="select__option__multiple" name="category[]" id="category" size="5"
                            aria-describedby="describe" multiple>
                        <?php
                        $categoryController = new CategoryController();
                        $categories         = $categoryController->readAll();
                        uasort($categories, [$categoryController, 'sortByName']);
                        ?>
                    ...
                    <small id="describe" class="form-text text-muted">
                      You may select multiple categories by pressing Ctrl + Left mouse button or Shift + Left mouse
                      button
                    </small>
                  </div>
          ...
          <div class="col-lg-6 col-12 md-mt-40 sm-mt-40">
            ...
            <div class="input_box">
              ...
              <input type="file" id="file" name="images[]" class="form-control-file" aria-describedby="describe"
                     multiple>
              <small id="describe" class="form-text text-muted">
