                            ...
                            <div class="shop-grid tab-pane fade show active" id="nav-grid"
                                ...
                                <ul class="wn__pagination">
                                    <?php for ($i = 1; $i <= $var['paginate']['countPages']; $i++): ?>
                                        ...
                                        <!--                                    </li>-->
                                    <?php endfor; ?>
                                    <li><a href="#"><i class="zmdi zmdi-chevron-right"></i>
                                </ul>
                            </div>
                            <div class="shop-grid tab-pane fade" id="nav-list"
                                ...
                                <div class="list__view__wrapper">
                                    <?php foreach ($var['books'] as $book): ?>
                                        <?php $book = (object)$book; ?>
                                        <!-- Start Single Product -->
                                        <div class="list__view mb-5">
                                            <div class="thumb">
                                                <a class="first__img" href="/book?id=<?php echo $book->getId(); ?>"><img
                                            ...
                                            <div class="content">
                                                <h2>
                                                    <a href="/book?id=<?php echo $book->getId(); ?>">
                                                        <?php echo $book->getAuthorSurname()
                                                            . ', ' . $book->getAuthorName()
                                                            . ' ' . $book->getTitle();
                                                        ?>
                                                    </a>
                                                ...
                                                <ul class="prize__box">
                                                    <li>$111.00</li>
                                                    <li class="old__prize">$<?php echo $book->getPrice(); ?></li>
                                                </ul>
                                                <p>
